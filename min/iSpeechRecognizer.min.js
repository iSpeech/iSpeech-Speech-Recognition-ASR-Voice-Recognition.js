...
return;this.state=iSpeechRecognizer.IDLE;this.worker.postMessage({command:'stop'});this.mediaStream.stop();this.node.disconnect();this.node.onaudioprocess=function(){};if(this.audioContext.close)this.audioContext.close();}
