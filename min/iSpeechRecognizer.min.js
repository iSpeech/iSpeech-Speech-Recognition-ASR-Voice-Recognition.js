...
return;navigator.getUserMedia({video:false,audio:true},this.startRecording.bind(this),function(error){this.onResponse({result:'error',code:10001,message:'Audio capture error: '+error.code});});this.switchState(iSpeechRecognizer.WAITING_USER);}
